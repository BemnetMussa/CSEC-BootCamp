...
const new_container = document.querySelector(".notes_container");
const modal = document.querySelector(".content");
const notes = [{ text: "task1", done: true }, { text: "task1", done: true }, { text: "task1", done: true }];
const remove_btn = (_a = document.querySelector(".cancel_btn")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
    remove_modal();
});
(_b = document.querySelector(".add_btn")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
    if (add_note) {
...
add_notes === null || add_notes === void 0 ? void 0 : add_notes.addEventListener("click", () => {
    console.log("click");
    console.log(input_value + " input vaule");
    ...
    if (new_container) {
        ...
        notes.forEach((note, index) => {
            ...
            checkbox === null || checkbox === void 0 ? void 0 : checkbox.addEventListener('change', (e) => {
                notes[index].done = e.target.checked;
                saveNotes();
            });
